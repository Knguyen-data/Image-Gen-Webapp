...
````yaml get /v1/ai/video/kling-v3/{task-id}
openapi: 3.0.0
info:
  description: >-
...
security:
  - apiKey: []
paths:
  /v1/ai/video/kling-v3/{task-id}:
    get:
      tags:
        - video
        - kling-v3
      summary: Kling 3 - Get task status
      description: >-
        Retrieve the status and result of a specific Kling 3 video generation
        task by its task ID.
      operationId: getAiVideoKlingV3Task
      parameters:
